...
export const GET = async ({ url, request }) => {
	...
	const isServerEnabledRecord = await pb
		.collection('settings')
		.getFirstListItem('setting_name="server_enabled"');
	...
	//const clientAddress = request.headers['x-forwarded-for'] || request.connection.remoteAddress;
